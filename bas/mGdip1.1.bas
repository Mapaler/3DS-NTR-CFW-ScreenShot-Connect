...
Public Function SaveImageToJPG(ByVal Image As Long, _
                               ...
                               Optional ByVal Quality As Long = 90) As GpStatus
...
Public Function SaveImageToTIF(ByVal Image As Long, ByVal Path As String) As GpStatus
    SaveImageToTIF = GdipSaveImageToFile(Image, StrPtr(Path), GetImageEncoderClsid( _
            TIF), ByVal 0)
End Function
